...
cmd_timezone = "set timezone"
cmd_schedule = "work schedule"
cmd_mute = "notification filter"
cmd_lots_bulk = "bulk lot operations"
cmd_discount = "auto-discount"
...
crd_raise_loop_err = "Auto-raise loop error: {}"
crd_raise_loop_fail_notify = "⚠️ <b>Auto-raise is failing</b>\n\n{} consecutive errors in the auto-raise loop.\nCheck the logs and FunPay status."
crd_session_loop_started = "$CYANThe session refresh loop is running."
crd_raise_403_retry = "Got 403 while raising lots. Refreshing session..."
gk_expired = "🔑 <b>Golden Key expired!</b>\n\nFunPay authorization is invalid. The bot cannot refresh the session.\n\n⚠️ Auto-raise, auto-delivery and notifications are <b>not working</b>.\n\nUpdate your golden_key to restore operation."
gk_recovered = "✅ <b>Golden Key restored!</b>\n\nSession updated successfully. The bot is operating normally."
gk_session_fail = "⚠️ <b>FunPay session issue</b>\n\nFailed to refresh session {} times in a row.\nFunPay may be temporarily unavailable or the golden_key may have expired."
gk_update_btn = "🔑 Update Golden Key"
...
crd_plugin_version_mismatch = "Plugin {} requires version >= {}, current: {}."
crd_plugin_deps_missing = "Plugin {} not loaded: missing dependencies: {}."
crd_plugins_failed_notify = "❌ <b>Plugin loading errors</b>\n\n{} plugin(s) failed to load:\n{}"
crd_plugin_auto_disabled = "Plugin {} auto-disabled after {} errors."
crd_plugin_auto_disabled_notify = "🔌 <b>Plugin disabled</b>\n\nPlugin <b>{}</b> was auto-disabled after {} consecutive errors.\nCheck the logs and update the plugin."
